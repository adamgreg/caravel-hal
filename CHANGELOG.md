...
## [2.0.0](https://github.com/adamgreg/caravel-hal/compare/v1.1.0...v2.0.0) - 2026-06-22

### Other

- [**breaking**] Bump caravel-pac dependency to v2
...
- Remove unnecessary linting allow attribute
- Rename timer module to timer0

## [1.0.9](https://github.com/adamgreg/caravel-hal/compare/v1.0.8...v1.0.9) - 2026-04-28

### Other

- Fix Timer0 when interrupts feature is disabled
...
- Gate more dependencies behind the "interrupts" feature
